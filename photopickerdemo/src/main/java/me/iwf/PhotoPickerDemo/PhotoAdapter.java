...
public class PhotoAdapter extends RecyclerView.Adapter<PhotoAdapter.PhotoViewHolder> {
    ...
    public PhotoViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case TYPE_ADD:
                itemView = inflater.inflate(me.iwf.PhotoPickerDemo.R.layout.__picker_item_photo_delete, parent, false);
                break;
            case TYPE_PHOTO:
                itemView = inflater.inflate(R.layout.__picker_item_photo_delete, parent, false);
                break;
        }
    ...
    public void onBindViewHolder(final PhotoViewHolder holder, final int position) {
        ...
        if (getItemViewType(position) == TYPE_PHOTO) {
            ...
            holder.ivPhoto.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (onPicCallBack != null) {
                        onPicCallBack.onPicClick(position);
                    }
                }
            });
            if (canLoadImage) {
            ...
            holder.ivPhoto.setBackgroundResource(R.mipmap.add);
